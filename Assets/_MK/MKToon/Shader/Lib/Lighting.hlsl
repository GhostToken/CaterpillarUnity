...
//////////////////////////////////////////////////////
	...
	MKLightData ComputeLightData(in MKLight light, in SurfaceData surfaceData)
	{
		...
		MKLight ComputeMainLight(in SurfaceData surfaceData, inout VertexOutputLight vertexOutputLight)
		{
			MKLight mkLight;
			INITIALIZE_STRUCT(MKLight, mkLight);
		...
		MKLight ComputeAdditionalLight(int index, in SurfaceData surfaceData, inout VertexOutputLight vertexOutputLight)
		{
			#if defined(MK_URP) || defined(MK_LWRP)
				MKLight mkLight;
	...
	// Lighting Indirect
	/////////////////////////////////////////////////////////////////////////////////////////////
	inline void LightingIndirect(inout Surface surface, in SurfaceData surfaceData, in MKPBSData pbsData, in MKLight light, in MKLightData lightData)
	{
		#ifdef MK_INDIRECT
	...
	// Lighting Direct
	/////////////////////////////////////////////////////////////////////////////////////////////
	inline void LightingDirect(inout Surface surface, in SurfaceData surfaceData, in MKPBSData pbsData, in MKLight light, in MKLightData lightData, out half4 finalLightColor)
	{
		#ifdef MK_LIT
			half4 diffuse;
			...
			//Surface Direct + Gooch
				...
				surface.rimBright = RimRawBright(diffuse.a, _RimSize, surfaceData.OneMinusVoN, _RimSmoothness * 0.5, surface, light);
